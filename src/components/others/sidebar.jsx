      ...
      <div className="flex flex-col items-center justify-between px-4 pt-6 pb-8">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="flex flex-col items-center gap-4">
            <div className=" relative cursor-pointer flex justify-center items-center rounded p-1 ">
            ...
            <div className="relative cursor-pointer flex justify-center items-center bg-[#F3F9FE] rounded p-1 ">
              <img
                ...
                className="inline w-[80%] 2xl:w-full"
                src={dashboard}
                alt=""
              />
              <div className={`${isHovered1 ? "inline" : "hidden"}`}>
                <button
                  style={{
                    boxShadow:
                      "0px 0px 1px #FFFFFF, 0px 15px 35px -5px rgba(17, 24, 38, 0.35), 0px 5px 15px -3px rgba(0, 0, 0, 0.2)",
                  }}
                  type="button"
                  className="absolute bg-[#13161E] text-sm tracking-[0.02em] -top-1 text-white rounded-lg px-3 left-14"
                >
                  Dashboard
                </button>
              </div>
